    ...
    <section id="education" className="py-20 bg-white border-b border-border">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          {/* College */}
          <div className="bg-white rounded-xl border border-border shadow-sm p-8 hover:shadow-md transition-shadow duration-200">
            <div className="flex flex-col md:flex-row md:items-start gap-6">
              ...
              <div className="flex-1">
                <div className="flex flex-wrap items-center justify-between gap-3 mb-2">
                  <span className="text-xs font-semibold uppercase tracking-wider text-primary bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                    B.Tech
                  </span>
                ...
                <p className="text-primary font-semibold mb-3">Sri Eshwar College of Engineering</p>
            ...
            <div className="flex flex-col md:flex-row md:items-start gap-6">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-4 text-sm text-gray-500">
                  ...
                  <div className="flex items-center gap-1">
                    <Award className="w-4 h-4 text-primary" />
                    <span className="font-semibold text-primary">92.17%</span>
                  </div>
                </div>
              </div>
            </div>
