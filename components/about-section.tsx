        ...
        <div className="grid lg:grid-cols-2 gap-14 items-start">
          ...
          <div className="grid grid-cols-2 gap-5 reveal-right">
            {[
              ...
              <div key={i} className="bg-white rounded-xl p-6 border border-border shadow-sm text-center hover:shadow-md hover:-translate-y-1 transition-all duration-200">
