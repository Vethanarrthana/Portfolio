      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-14">
          {featuredProjects.map((project, i) => {
            ...
            return (
              <div key={project.id} className="bg-white rounded-xl border border-border shadow-sm hover:shadow-lg hover:-translate-y-1.5 transition-all duration-300 overflow-hidden flex flex-col reveal" style={{ transitionDelay: `${i * 0.1}s` }}>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {otherProjects.map((project, i) => {
            ...
            return (
              <div key={project.id} className="bg-white rounded-xl border border-border shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-200 p-6 flex gap-5 reveal" style={{ transitionDelay: `${i * 0.1}s` }}>
