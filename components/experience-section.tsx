      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          {experience.list.map((exp, index) => (
            <div key={index} className="bg-white rounded-xl border border-border shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 p-7 reveal" style={{ transitionDelay: `${index * 0.1}s` }}>
